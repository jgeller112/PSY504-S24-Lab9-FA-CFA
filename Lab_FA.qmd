...
3.  Determine how many factors to extract. Inspect and interpret the scree plot, parallel plot, and the consensus method. For the scree and paraellel plot use `fa.parallel`
...
> Does that help with interpretation?

::: callout-note
## ANSWER
:::

> if not, try setting threshold to "max"
